...
public class Utility {
    ...
    public static String inFixExpResult(String postFixExp) throws StackException {
        String result=infixToPostfixConverter(postFixExp);
        return postFixExpResult(result);
    }
    ...
    public static String postFixExpResult(String exp) throws StackException {
        LinkedStack s = new LinkedStack();
