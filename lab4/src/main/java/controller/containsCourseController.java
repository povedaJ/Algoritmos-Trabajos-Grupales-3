...
public class containsCourseController {
    ...
    public void initialize() {
        ...
        this.alert = util.FXUtility.alert("Courses Doubly Linked List", "Searching courses...");
    }
    ...
    void btnAdd(ActionEvent event) {
        alert.setHeaderText("Searching course");
        try {
            if (isValid()) {
                ...
                if (!courseList.isEmpty()&& courseList.contains(newCourse) ) {
                    ...
                    alert.setContentText("The course exist in the list");
                    //tenemos que settear la lista de la clase Utility
                    //actualizo la lista global

                } else {
                    alert.setAlertType(Alert.AlertType.INFORMATION);
                    alert.setContentText("The course doesn't exist in the list");
                }
            } else {
