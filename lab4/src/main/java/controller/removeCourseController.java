...
public class removeCourseController {
    ...
    public void initialize() {
        ...
        this.alert = util.FXUtility.alert("Courses Doubly Linked List", "Remove courses...");
    }
    ...
    void btnRemove(ActionEvent event) {
        alert.setHeaderText("Removing Courses...");
        try {
            if (isValid()) {
